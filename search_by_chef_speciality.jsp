...
<main class="main-content">
    <div class="search-bar">
        <form action="search_by_chef_speciality.jsp" method="post">
            <input type="text" name="ccity" placeholder="Enter city...">
            <input type="text" name="cspeciality" placeholder="Enter speciality...">
            ...
            <tbody>
                <% 
                    try {
                        ...
                        String query = "SELECT * FROM chef WHERE ccity LIKE ? AND cstatus = 'Approved' AND cspeciality LIKE ?";
                        PreparedStatement ps = con.prepareStatement(query);
                        ps.setString(1, "%" + ccity + "%");
                        ps.setString(2, "%" + cspeciality + "%");
                ...
                <tr>
                    ...
                    <td><a href="book.jsp?cid=<%= rs.getInt("cid") %>" class="book-btn">Book</a></td>
