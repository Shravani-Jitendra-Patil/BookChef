                ...
                <tbody>
                    <% 
                        try {
                            ...
                            PreparedStatement ps = con.prepareStatement("select * from chef where cstatus='Disapproved'");
                    ...
                    <tr>
                        ...
                        <td><%= rs.getString("cstatus") %></td> <!-- Displaying status from users table -->
                    </tr>
                    <% 
                            }
                        } catch (Exception e) {
